...
typedef struct Face {
    uint8_t intensity; /* this user attaches intensity to faces */
    uint8_t nverts;    /* number of vertex indices in list */
...
extern int            ply_get_element(PlyFile *, void *);
...
extern void           read_test(char *filename, int *num_faces, int *num_vertices, Vertex ***vlist, Face ***flist);
